...
export default defineConfig({
    plugins: [
        ...
        Components({
            dirs: ["./resources/ts/**/components", "resources/ts/@core/components", "resources/ts/views", "resources/ts/components"],
            dts: true,
            resolvers: [
                componentName => {
    ...
    resolve: {
        alias: {
            ...
            "@axios": fileURLToPath(new URL("./resources/ts/utils/axios", import.meta.url)),
