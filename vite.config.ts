...
export default defineConfig({
  plugins: [
    ...
    AutoImport({
      ...
      dirs: ["./resources/ts/@core/utils", "./resources/ts/@core/composable/", "./resources/ts/composables/", "./resources/ts/utils/", "./resources/ts/plugins/*/composables/*", "./resources/ts/views/**/*"],
      vueTemplate: true,
