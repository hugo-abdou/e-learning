...
const translateMouse = computed(() => {
    if (typeof window !== "undefined") {
        ...
        return {
            transform: `perspective(1200px) rotateX(${rotateX.value < -40 ? -20 : rotateX.value}deg) rotateY(${
            ...
            <div class="landing-hero" :class="theme.current.value.dark ? 'landing-hero-dark-bg' : 'landing-hero-light-bg'">
                <VContainer>
                    <div class="hero-text-box text-center px-6">
                        ...
                        <h5 class="mb-6 text-h5">Production-ready & easy to use Admin Template for Reliability and Customizability.</h5>
                        <div class="position-relative">
                            <h6 class="position-absolute hero-btn-item d-md-flex d-none text-h6">
                                Join Community
                                <VImg :src="joinArrow" class="flip-in-rtl" width="60" height="42" />
                            </h6>
        ...
        <VContainer>
            <div class="position-relative">
                ...
                <div class="hero-animation-img position-absolute">
                    <RouterLink :to="{ name: 'root' }" target="_blank">
