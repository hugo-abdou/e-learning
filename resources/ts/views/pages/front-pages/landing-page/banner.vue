        ...
        <VContainer>
            <div class="d-flex align-center justify-center justify-md-space-between flex-wrap gap-6 gap-x-10 position-relative pt-10">
                <div class="d-flex justify-start align-center">
                    <div>
                        <h2 class="text-h2 text-primary font-weight-bold">Ready to Get Started?</h2>
                        <h5 class="text-h5 font-weight-medium mb-8">Start your project with a 14-day free trial</h5>
                        <VBtn color="primary" :to="{ name: 'root' }" height="48"> Get Started </VBtn>
                    </div>
                </div>
