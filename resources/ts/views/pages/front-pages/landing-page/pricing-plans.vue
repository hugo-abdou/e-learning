...
const pricingPlans = [
    ...
    },
    {
        ...
        monthlyPrice: 29,
        yearlyPrice: 264,
        features: ["Everything in basic", "Timeline with database", "Advanced search", "Marketing automation", "Advanced chatbot", "Campaign management", "Collaboration tools"],
    ...
    },
    {
        ...
        monthlyPrice: 49,
        yearlyPrice: 444,
        features: ["Campaign management", "Timeline with database", "Fuzzy search", "A/B testing sanbox", "Custom permissions", "Social media automation", "Sales automation tools"],
