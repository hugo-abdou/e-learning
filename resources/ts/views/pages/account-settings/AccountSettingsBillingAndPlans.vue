                ...
                <VCardText>
                    <VRow>
                        <VCol cols="12" md="6">
                            <div>
                                <div class="mb-6">
                                    <h3 class="text-base font-weight-medium mb-1">Your Current Plan is Basic</h3>
                                    <p class="text-base">A simple start for everyone</p>
                                </div>

                                <div class="mb-6">
                                    <h3 class="text-base font-weight-medium mb-1">Active until Dec 09, 2021</h3>
                                    <p class="text-base">We will send you a notification upon Subscription expiration</p>
                                </div>
                        ...
                        <VCol cols="12" md="6">
                            ...
                            <p class="text-base mt-2 mb-0">6 days remaining until your plan requires update</p>
                        </VCol>

                        <VCol cols="12">
                            <div class="d-flex flex-wrap gap-y-4">
                                <VBtn class="me-3" @click="isPricingPlanDialogVisible = true"> upgrade plan </VBtn>

                                <VBtn color="secondary" variant="tonal" @click="isConfirmDialogVisible = true"> Cancel Subscription </VBtn>
                            </div>
                        </VCol>
                    </VRow>
                    ...
                    <VDialog v-model="isPricingPlanDialogVisible" class="v-dialog-xl">
                        <!-- Dialog close btn -->
                        ...
                        <VRow>
                                ...
                                <VRow>
                                    ...
                                    <VCol cols="12">
                                        <VRadioGroup v-model="selectedPaymentMethod" inline>
                                            ...
                                            <VRadio value="cod-cheque" label="COD/Cheque" color="primary" />
                                        </VRadioGroup>
                                    </VCol>
                                    ...
                                    <VCol cols="12">
                                        <VRow v-show="selectedPaymentMethod === 'credit-debit-atm-card'">
                                            <!-- 👉 Card Number -->
                                            <VCol cols="12">
                                                <VTextField v-model="cardNumber" label="Card Number" type="number" />
                                            </VCol>

                                            <!-- 👉 Name -->
                                            <VCol cols="12" md="6">
                                                <VTextField v-model="cardName" label="Name" />
                                            </VCol>

                                            <!-- 👉 Expiry date -->
                                            <VCol cols="6" md="3">
                                                <VTextField v-model="cardExpiryDate" label="Expiry Date" />
                                            </VCol>
                                        ...
                                        <p v-show="selectedPaymentMethod === 'cod-cheque'" class="text-base">
                            ...
                            <VCol cols="12" md="6">
                                ...
                                <div class="d-flex flex-column gap-y-4">
                                    <VCard v-for="card in creditCards" :key="card.name" flat variant="tonal">
                                        <VCardText class="d-flex flex-sm-row flex-column pa-4">
                                            ...
                                            <div class="d-flex flex-column text-sm-end">
                                                <div class="d-flex flex-wrap gap-4 order-sm-0 order-1">
                                                    <VBtn variant="tonal" @click="openEditCardDialog(card)"> Edit </VBtn>
                            ...
                            <VCol cols="12" class="d-flex flex-wrap gap-4">
                                ...
                                <VBtn color="secondary" variant="tonal" @click="resetPaymentForm"> Reset </VBtn>
                            </VCol>
                        </VRow>
                    </VForm>
                </VCardText>
                ...
                <VCardText>
                    <VForm @submit.prevent="() => {}">
                        <VRow>
                            ...
                            <!-- 👉 Mobile -->
                            <VCol cols="12" md="6">
                                <VTextField dirty label="Phone Number" type="number" prefix="US (+1)" />
                            </VCol>

                            <!-- 👉 Country -->
                            <VCol cols="12" md="6">
                                <VSelect label="Country" :items="countryList" />
                            </VCol>
