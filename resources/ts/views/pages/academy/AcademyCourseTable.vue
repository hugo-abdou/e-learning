    ...
    <VCard>
        ...
        >
            ...
            <template #item.progress="{ item }">
                ...
                >
                    <div class="text-no-wrap font-weight-medium text-high-emphasis">{{ Math.floor((item.completedTasks / item.totalTasks) * 100) }}%</div>
                    <div class="w-100">
                        <VProgressLinear
                            color="primary"
                            height="8"
                    ...
                    <div class="text-disabled">{{ item.completedTasks }}/{{ item.totalTasks }}</div>
                </div>
            </template>
