...
<template>
    <div class="footer">
        <div class="footer-top pt-15" :style="{ 'background-image': `url(${footerBg})` }">
            <VContainer>
                <VRow>
                    <!-- 👉 Footer  -->
                    <VCol cols="12" md="5">
                        <div class="mb-4" :class="$vuetify.display.smAndDown ? 'w-100' : 'w-75'">
                            ...
                            <div class="mb-8" :class="$vuetify.theme.current.dark ? 'text-body-1' : 'text-white-variant'">
                            ...
                            <VForm class="subscribe-form d-flex align-center">
                                <AppTextField label="Subscribe to newsletter" placeholder="john@email.co" density="compact" />
                                <VBtn class="align-self-end rounded-s-0" height="40"> Subscribe </VBtn>
                            </VForm>
                        </div>
                    </VCol>
                    ...
                    <VCol cols="12" md="2" sm="4">
                        <div>
                            <div class="font-weight-medium mb-6">Demos</div>
                    ...
                    <VCol cols="12" md="2" sm="4">
                        <div>
                            <div class="font-weight-medium mb-6">Pages</div>
                            <ul style="list-style: none">
                                <li v-for="(item, index) in pagesList" :key="index" class="mb-4">
                                    ...
                                    <template v-if="item.isNew">
                                        <VChip color="primary" variant="elevated" label> New </VChip>
                                    </template>
                                </li>
                            </ul>
                        </div>
                    ...
                    <VCol cols="12" md="3" sm="4">
                        <div>
                            <div class="font-weight-medium mb-6">Download our app</div>
            ...
            <VContainer>
                <div class="d-flex justify-space-between flex-wrap gap-y-4 align-center">
                    <span class="text-wrap me-4">
                        ...
                        <a href="https://pixinvent.com/" target="_blank" rel="noopener noreferrer" class="font-weight-bold ms-1 text-white"
                            >Pixinvent</a
                        >, Made With
                    ...
                    <div class="d-flex gap-x-6">
                        ...
                        >
                            <a :href="item.href" target="_blank" rel="noopener noreferrer">
                                <VAvatar size="16" class="rounded-0">
                                    <VImg :src="item.icon" width="16" />
                                </VAvatar>
                            </a>
                        </template>
                    </div>
