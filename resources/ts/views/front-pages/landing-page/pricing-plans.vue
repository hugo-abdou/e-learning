        ...
        <VContainer>
            <div class="pricing-plans">
                ...
                <div class="d-flex align-center justify-center mx-auto my-10">
                    <VLabel for="pricing-plan-toggle" class="me-2 font-weight-medium"> Pay Monthly </VLabel>
                    <div class="position-relative">
                        <VSwitch id="pricing-plan-toggle" v-model="annualMonthlyPlanPriceToggler" label="Pay Annual" />
                    ...
                    <VCol v-for="(plan, index) in pricingPlans" :key="index">
                        <VCard :style="plan.current ? 'border:2px solid rgb(var(--v-theme-primary))' : ''">
                            <VCardText class="pa-8">
                                <VImg :src="plan.image" width="80" height="80" class="mx-auto mb-8" />
                                ...
                                <VBtn block :variant="plan.current ? 'elevated' : 'tonal'" class="mt-8" :to="{ name: 'root' }">
                                    Get Started
                                </VBtn>
                            </VCardText>
                        </VCard>
