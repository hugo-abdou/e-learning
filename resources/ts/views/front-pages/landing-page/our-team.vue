  ...
  <VContainer id="team">
    <div class="our-team">
      <div class="headers d-flex justify-center flex-column align-center">
        <VChip label color="primary" class="mb-4"> OUR GREAT TEAM </VChip>

        <div class="d-flex align-center text-h3 mb-1 flex-wrap justify-center">
          <div class="position-relative me-2">
            <h3 class="section-title">Supported</h3>
          </div>
          by Real People
        </div>

        <p class="text-center">Who is behind these great-looking interfaces?</p>
      </div>
