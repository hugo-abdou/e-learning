        ...
        <VRow>
            ...
            <VCol cols="12">
                <GalleryView ref="gallery" deletable search-posisions="90px">
                    <template #actions>
                        <VBtn prepend-icon="mdi-image-plus-outline" @click="isAddMediaDialogOpen = true"> Add Media </VBtn>
                    </template>
                </GalleryView>
            </VCol>
        </VRow>
        <FileUploaderDialog v-model:is-dialog-visible="isAddMediaDialogOpen" :max-number-of-files="100" @done="uploadDone" />
    </div>
</template>
