...
<template>
  <div>
    ...
    <div class="mb-6">
      <VRow>
        <VCol cols="12" md="6">
          <VCard flat color="rgba(115, 103, 240, 0.08)">
            <VCardText>
              <div
              ...
              >
                ...
                <div class="align-self-center">
                  <div class="align-self-center">
                    <img :src="boyAppAcademy" height="127" />
                  </div>
                </div>
              </div>
            </VCardText>
        ...
        <VCol cols="12" md="6">
          <VCard variant="tonal" flat color="error">
            <VCardText>
              <div
                class="d-flex flex-column-reverse flex-sm-row gap-4 justify-space-between"
              >
                <div class="text-center text-sm-start">
                  <h5 class="text-h5 text-error mb-1">
                    ...
                    >
                      <div class="text-center text-sm-start">
                        ...
                        <p
                          class="text-body-1 text-high-emphasis text-wrap mb-6"
                        />
                      </div>
                    </div>
                  </h5>
                ...
                <div class="align-self-center">
                  <div class="align-self-center">
                    <img :src="girlAppAcademy" height="127" />
                  </div>
                </div>
              </div>
            </VCardText>
    ...
    <VCard>
      <VCardText>
        <VRow>
          <VCol cols="12" md="4">
            <div
              class="d-flex flex-column align-center gap-y-4 h-100 justify-center"
            >
