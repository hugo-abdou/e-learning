...
<template>
    ...
    <template v-if="true">
        <VBtn icon size="small" class="app-customizer-toggler rounded-s-lg rounded-0" style="z-index: 1001" @click="isNavDrawerOpen = true">
            <VIcon size="22" icon="tabler-settings" />
        </VBtn>

        <VNavigationDrawer v-model="isNavDrawerOpen" temporary border="0" location="end" width="400" :scrim="false" class="app-customizer">
            <!-- 👉 Header -->
            ...
            <PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
                ...
                <CustomizerSection title="THEMING" :divider="false">
                    ...
                    <div class="d-flex gap-x-4 mt-2">
                        <div
                            ...
                            :class="{
                                'elevation-4': vuetifyTheme.current.value.colors.primary === getBoxColor(initialThemeColors[color], index)
                            }"
                ...
                <CustomizerSection title="MENU">
                    ...
                    <!-- 👉 Collapsed Menu -->
                    <div v-if="appContentLayoutNav === AppContentLayoutNav.Vertical" class="mt-4 d-flex align-center justify-space-between">
                        <VLabel for="customizer-menu-collapsed" class="text-high-emphasis"> Collapsed Menu </VLabel>
                        <div>
                    ...
                    <div
                        ...
                        "
                    >
                        <VLabel for="customizer-menu-semi-dark" class="text-high-emphasis"> Semi Dark Menu </VLabel>
                        <div>
                    ...
                    <div class="mt-6">
                        <VRow>
                            <VCol cols="5" class="d-flex align-center">
                                <VLabel for="route-transition" class="text-high-emphasis"> Router Transition </VLabel>
                            </VCol>
