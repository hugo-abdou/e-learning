...
export const CourseStatusColors = {
  Draft: '#888888', // Cool Blue for Draft status
  Private: '#8e44ad', // Cool Green for Private status
  Scheduled: '#3498db', // Yellow for Scheduled status
  Published: '#27ae60', // Cool Purple for Published status
  Closed: '#f1c40f', // Cool Red for Closed status
  Error: '#e74c3c', // Same Cool Red for Error status
} as const
