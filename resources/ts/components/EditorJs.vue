            ...
            uploader: {
                uploadByFile(file: File) {
                    return new Promise((resolve, reject) => {
                        ...
                        $resumable.on("fileSuccess", (file: ResumableFile, message: string) => {
                            if (message !== "Ok") {
...
.cdx-search-field__input {
    color: rgba(var(--v-theme-background), var(--v-high-emphasis-opacity)) !important;
}

@media (hover: hover) {
    .ce-toolbar__settings-btn:hover,
    .ce-toolbar__plus:hover {
        background-color: rgba(var(--v-theme-surface), var(--v-high-emphasis-opacity)) !important;
    }
}
