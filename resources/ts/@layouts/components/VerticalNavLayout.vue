...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        return () => {
            ...
            return h("div", { class: ["layout-wrapper", ...configStore._layoutClasses] }, [verticalNavWrapper ? h(verticalNavWrapper, verticalNavWrapperProps, { default: () => verticalNav }) : verticalNav, h("div", { class: "layout-content-wrapper" }, [navbar, main, footer]), layoutOverlay]);
        };
    },
});
</script>
