...
<head>
    ...
    <script src="https://assets.mediadelivery.net/hls/1.4.8/hls.min.js"></script>
    ...
    <script type="text/javascript" src="https://assets.mediadelivery.net/jquery/jquery-3.7.1.min.js"></script>
    ...
    <link rel="stylesheet" href="https://assets.mediadelivery.net/plyr/3.7.3.2/plyr.css">
    <link rel="stylesheet" href="https://assets.mediadelivery.net/plyr-vr.css">
    <script src="https://assets.mediadelivery.net/pb.js?v=1"></script>
    <link rel="stylesheet" href="https://assets.mediadelivery.net/pb.css?v=1">
    ...
    <meta property="og:url"
        content="https://iframe.mediadelivery.net/embed/179002/c84c6062-78d3-4051-b44a-2045cb62b6fa">
    <meta property="og:image"
        content="https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/thumbnail.jpg">
    <meta property="og:image:secure_url"
        content="https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/thumbnail.jpg">
    <meta property="og:site_name" content="bunny.net">
    <meta property="og:title" content="Vidéo sans titre ‐ Réalisée avec Clipchamp.mp4">
    <meta property="og:description" content="">
    <meta property="og:type" content="video.other">

    <meta property="og:video:url"
        content="https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/play_720p.mp4">
    ...
    <meta property="video:duration" content="00:01:33.0000000">
    ...
    <meta property="twitter:url"
        content="https://iframe.mediadelivery.net/embed/179002/c84c6062-78d3-4051-b44a-2045cb62b6fa">
    <meta name="twitter:title" content="Vidéo sans titre ‐ Réalisée avec Clipchamp.mp4">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "VideoObject",
      "name": "Vid&#233;o sans titre ‐ R&#233;alis&#233;e avec Clipchamp.mp4",
      "description": "",
      "thumbnailUrl": "https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/thumbnail.jpg",
      "uploadDate": "2023-12-08T18:27:30.5410000",
      "duration": "00:01:33.0000000",
      "embedUrl": "https://iframe.mediadelivery.net/embed/179002/c84c6062-78d3-4051-b44a-2045cb62b6fa"
    }
</script>
    ...
    <script src="//www.gstatic.com/eureka/clank/119/cast_sender.js"></script>
</head>
...
<body id="body">
    <div hidden="" id="sprite-plyr">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <symbol id="plyr-rewind" viewBox="0 0 28 28">
                <path
    ...
    <div class="container" id="video-container" style="margin-top: 0px;">
        ...
        <div tabindex="0"
            ...
            <div class="plyr__controls"><button class="plyr__controls__item plyr__control" type="button"
                    data-plyr="play" aria-pressed="false"
                    aria-label="Play, Vidéo sans titre ‐ Réalisée avec Clipchamp.mp4"><svg class="icon--pressed"
                        ...
                        class="label--not-pressed plyr__sr-only">Play</span></button><button
                    class="plyr__controls__item plyr__control" type="button" data-plyr="rewind"
                    aria-pressed="false"><svg aria-hidden="true" focusable="false">
                        <use xlink:href="#plyr-rewind"></use>
                    </svg><span class="plyr__sr-only">Rewind 10s</span></button><button
                    class="plyr__controls__item plyr__control" type="button" data-plyr="fast-forward"
                    aria-pressed="false"><svg aria-hidden="true" focusable="false">
                        <use xlink:href="#plyr-fast-forward"></use>
                    </svg><span class="plyr__sr-only">Forward 10s</span></button>
                <div class="plyr__controls__item hide_mobile plyr__spacer"></div>
                <div class="plyr__controls__item plyr__progress__container">
                    <div class="plyr__progress">
                        <div class="plyr__pb" style="pointer-events: none;">
                            <div class="sp__base">
                                <ul class="sp__progressbar">
                                    <li style="width: 604.996px;">
                                        <div class="sp__container">
                                            <div class="sp__bg"></div>
                                            <div class="sp__section"
                                                style="background-color: rgba(255, 255, 255, 0.533); z-index: 1; width: 0px;">
                                            </div>
                                            <div class="sp__section"
                                                style="background-color: rgba(255, 255, 255, 0.314); z-index: 2; width: 604.996px;">
                                            </div>
                                            <div class="sp__section"
                                                style="background-color: rgb(83, 84, 254); z-index: 3; width: 0px;">
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                <div class="sp__title animated">test</div>
                            </div>
                        </div><input data-plyr="seek" type="range" min="0" max="100" step="0.01"
                            value="0" autocomplete="off" role="slider" aria-label="Seek" aria-valuemin="0"
                            aria-valuemax="92.233333" aria-valuenow="0" id="plyr-seek-4865"
                            aria-valuetext="00:00 of 00:00" style="--value: 0%; top: -5px;"
                            seek-value="-1.0934721032870036"><progress class="plyr__progress__buffer" min="0"
                            max="100" value="100" role="progressbar" aria-hidden="true"
                            style="top: 4px; opacity: 0.01;">% buffered</progress><span class="plyr__tooltip"
                            hidden="" style="left: 0%;">00:00</span>
                        <div class="plyr__preview-thumb" style="left: -11.4844px;">
                            <div class="plyr__preview-thumb__image-container" style="height: 89px; width: 158px;"><img
                                    src="https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/seek/_0.jpg"
                                    data-index="0" style="height: 528px; width: 942px; left: 0px; top: 0px;"></div>
                ...
                <div class="plyr__controls__item plyr__time--duration plyr__time" aria-label="Duration">01:32</div>
                <div class="plyr__controls__item plyr__volume"><button type="button" class="plyr__control"
                        data-plyr="mute" aria-pressed="false"><svg class="icon--pressed" aria-hidden="true"
                            focusable="false">
                            <use xlink:href="#plyr-muted"></use>
                        </svg><svg class="icon--not-pressed" aria-hidden="true" focusable="false">
                            <use xlink:href="#plyr-volume"></use>
                        </svg><span class="label--pressed plyr__sr-only">Unmute</span><span
                            class="label--not-pressed plyr__sr-only">Mute</span></button><input data-plyr="volume"
                        type="range" min="0" max="1" step="0.05" value="1"
                        autocomplete="off" role="slider" aria-label="Volume" aria-valuemin="0" aria-valuemax="100"
                        aria-valuenow="100" id="plyr-volume-4865" aria-valuetext="100.0%" style="--value: 100%;">
                </div>
                <div class="plyr__controls__item plyr__menu"><button aria-haspopup="true"
                        aria-controls="plyr-settings-4865" aria-expanded="false" type="button"
                        class="plyr__control" data-plyr="settings" aria-pressed="false"><svg aria-hidden="true"
                            focusable="false">
                            <use xlink:href="#plyr-settings"></use>
                        </svg><span class="plyr__sr-only">Settings</span></button>
                    <div class="plyr__menu__container" id="plyr-settings-4865" hidden="">
                        <div>
                            <div id="plyr-settings-4865-home">
                                <div role="menu"><button data-plyr="settings" type="button"
                                        ...
                                        aria-haspopup="true"><span>Quality<span
                                                class="plyr__menu__value">Auto</span></span></button><button
                                        data-plyr="settings" type="button"
                                        class="plyr__control plyr__control--forward" role="menuitem"
                                        aria-haspopup="true"><span>Speed<span
                                                class="plyr__menu__value">Normal</span></span></button><button
                                        data-plyr="settings" type="button"
                                        class="plyr__control plyr__control--forward" role="menuitem"
                                        aria-haspopup="true" hidden=""><span>Loop<span
                                                class="plyr__menu__value">undefined</span></span></button></div>
                            </div>
                            <div id="plyr-settings-4865-quality" hidden=""><button type="button"
                                    class="plyr__control plyr__control--back"><span
                                        aria-hidden="true">Quality</span><span class="plyr__sr-only">Go back to
                                        previous menu</span></button>
                                <div role="menu"><button data-plyr="quality" type="button" role="menuitemradio"
                                        class="plyr__control" aria-checked="true" value="0"><span>Auto
                                            (480p)</span></button><button data-plyr="quality" type="button"
                                        role="menuitemradio" class="plyr__control" aria-checked="false"
                                        value="240"><span>240p</span></button><button data-plyr="quality"
                                        type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="false" value="360"><span>360p</span></button><button
                                        data-plyr="quality" type="button" role="menuitemradio"
                                        class="plyr__control" aria-checked="false" value="480"><span>480p<span
                                                class="plyr__menu__value"><span
                                                    class="plyr__badge">SD</span></span></span></button><button
                                        data-plyr="quality" type="button" role="menuitemradio"
                                        ...
                                        class="plyr__control" aria-checked="false" value="1080"><span>1080p<span
                                                class="plyr__menu__value"><span
                                                    class="plyr__badge">HD</span></span></span></button></div>
                            </div>
                            <div id="plyr-settings-4865-speed" hidden=""><button type="button"
                                    class="plyr__control plyr__control--back"><span
                                        aria-hidden="true">Speed</span><span class="plyr__sr-only">Go back to previous
                                        menu</span></button>
                                <div role="menu"><button data-plyr="speed" type="button" role="menuitemradio"
                                        ...
                                        data-plyr="speed" type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="true" value="1"><span>Normal</span></button><button
                                        data-plyr="speed" type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="false" value="1.25"><span>1.25×</span></button><button
                                        data-plyr="speed" type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="false" value="1.5"><span>1.5×</span></button><button
                                        data-plyr="speed" type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="false" value="1.75"><span>1.75×</span></button><button
                                        data-plyr="speed" type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="false" value="2"><span>2×</span></button><button
                                        data-plyr="speed" type="button" role="menuitemradio" class="plyr__control"
                                        aria-checked="false" value="4"><span>4×</span></button></div>
                            </div>
                            <div id="plyr-settings-4865-loop" hidden=""><button type="button"
                                    class="plyr__control plyr__control--back"><span
                                        aria-hidden="true">Loop</span><span class="plyr__sr-only">Go back to previous
                                        menu</span></button>
                                <div role="menu"></div>
                            </div>
                        </div>
                    ...
                    class="plyr__controls__item plyr__control" type="button" data-plyr="fullscreen"
            ...
            <div class="plyr__video-wrapper"><video id="main-video" preload="auto" crossorigin="" none=""
                    data-plyr-config="{ &quot;title&quot;: &quot;Vidéo sans titre ‐ Réalisée avec Clipchamp.mp4&quot; }"
                    playsinline=""
                    data-poster="https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/thumbnail.jpg"
                    src="blob:https://iframe.mediadelivery.net/c7313ae9-18a9-473b-94c5-dd29e3445df5">

                    <source type="application/x-mpegURL"
                        src="https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/playlist.m3u8">
                ...
                <div class="plyr__poster"
                    style="background-image: url(&quot;https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/thumbnail.jpg&quot;);">
                </div>
                <div class="plyr__preview-scrubbing"></div>
            </div>
            <div class="plyr__captions" dir="auto"></div><button type="button"
                class="plyr__control plyr__control--overlaid" data-plyr="play" aria-pressed="false"
                aria-label="Play, Vidéo sans titre ‐ Réalisée avec Clipchamp.mp4"><svg aria-hidden="true"
                    focusable="false">
                    <use xlink:href="#plyr-play"></use>
    ...
    <script>
        ...
        var videoSessionTracker = new BunnyStreamSessionTracker("mediadelivery.net", "video-803.mediadelivery.net", 179002,
            "c84c6062-78d3-4051-b44a-2045cb62b6fa", "803");
        var errorEvents = {};
        ...
        document.addEventListener("DOMContentLoaded", async function() {
            ...
            var originalUrl = 'https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/original';
            var urlPlaylistUrl =
                    ...
                    $('.chromecast').click(function() {
                        if (cjs.available) {
                            if (cjs.connected) {
                                ...
                                cjs.cast(castUrl, {
                                    poster: 'https://vz-217be1d9-d51.b-cdn.net/c84c6062-78d3-4051-b44a-2045cb62b6fa/thumbnail.jpg',
                                    title: 'Vid&#233;o sans titre ‐ R&#233;alis&#233;e avec Clipchamp.mp4',
                                    subtitles: []
                                })
                            }
                        }
            ...
            function initPlayer() {
                ...
                $('<div class="plyr__controls__item hide_mobile plyr__spacer"></div>').insertBefore(
                    ".plyr__progress__container");
                ...
                var pb = new PB(".plyr__pb", ".plyr__progress__container input", {
                    ...
                    onScrubbingChange: function(seekTime, offset) {
                        ...
                        position = Math.min($(".plyr__controls").width() - $(".plyr__preview-thumb")
                            .width() + (thumbWidth / 4), position);
                ...
                function subscribeAdManagerEvent() {
                    if (player.ads != null) {
                        ...
                        Object.keys(google.ima.AdEvent.Type).forEach(function(e) {
                            ...
                            player.ads.manager.addEventListener(google.ima.AdEvent.Type[e], function(
                                e) {
                                switch (e.type) {
                                    case 'pause':
                                        isAdPaused = true;
                ...
                setInterval(function() {
                    ...
                    if (!video.paused) {
                        ...
                        loadUrl("https://video-803.mediadelivery.net/.metrics/add?errorEvents=" +
                            errorEventsString + "&bandwidth=" + bandwidth + "&zoneTier=" + 'volume',
                            function(data) {});
                        errorEvents = {};
                    }
                }, 15000);
