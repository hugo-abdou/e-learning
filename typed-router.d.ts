...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'course-components-lessons-play-list': RouteRecordInfo<'course-components-lessons-play-list', '/course/components/LessonsPlayList', Record<never, never>, Record<never, never>>,
    'course-components-quizzes-play-list': RouteRecordInfo<'course-components-quizzes-play-list', '/course/components/QuizzesPlayList', Record<never, never>, Record<never, never>>,
    ...
    'quizzes-components-collapsed-content': RouteRecordInfo<'quizzes-components-collapsed-content', '/quizzes/components/CollapsedContent', Record<never, never>, Record<never, never>>,
    'quizzes-components-quizzes-form': RouteRecordInfo<'quizzes-components-quizzes-form', '/quizzes/components/QuizzesForm', Record<never, never>, Record<never, never>>,
    'quizzes-create': RouteRecordInfo<'quizzes-create', '/quizzes/create', Record<never, never>, Record<never, never>>,
    'quizzes-create-old': RouteRecordInfo<'quizzes-create-old', '/quizzes/create-old', Record<never, never>, Record<never, never>>,
